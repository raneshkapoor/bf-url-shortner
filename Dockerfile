...
# This assumes your main JAR will be named `bf-url-shortner-0.0.1-SNAPSHOT.jar` based on your
...
# The JAR is copied from `/app/build/libs/bf-url-shortner-0.0.1-SNAPSHOT.jar` in the builder stage
# and renamed to `app.jar` in the current stage for simplicity.
COPY --from=builder /app/build/libs/bf-url-shortner-0.0.1-SNAPSHOT.jar app.jar
